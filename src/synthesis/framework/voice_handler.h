...
namespace vital {
  ...
  class Voice {
    public:
      ...
      force_inline bool adjacentNoteRetrigger() { return adjacent_note_retrigger_; }
      ...
      force_inline void activate(int midi_note, mono_float tuned_note, mono_float velocity,
        ...
        adjacent_note_retrigger_ = key_state_ == kReleased && event_sample_ == sample && state_.channel == channel;
  ...
  class VoiceHandler : public SynthModule, public NoteHandler {
    public:
      ...
      force_inline void setModWheel(mono_float value, int channel = 0) {
        ...
        mod_wheel_.trigger_value = value;
      }
      ...
      force_inline void setPitchWheel(mono_float value, int channel = 0) {
        ...
        pitch_wheel_.trigger_value = value;
        pitch_wheel_percent_.trigger_value = value * 0.5f + 0.5f;
